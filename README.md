...
- Описание запросов:
  - GET/users - отдаёт информацию о всех пользователей. Для каждого составляет список номеров, зарегистраированных на этого пользователя. Отдаёт сколько пользователь платит в месяц с учётом тарифа и опций для каждого номера.пппукпувппеаипе
